        ...
        <>
            <div className="jumbotron mt-3 py-4">
                <div className="d-flex justify-content-end">
                    <button onClick={e => logout(e)} className="btn btn-lg" style={{ color: "white", backgroundColor: "#F6D55C" }}>Logout</button>
                </div>
                <h1 className="display-4">Password Manager!</h1>
                <p className="lead">This is a simple password manager application</p>
                <hr className="my-4" />
                <button onClick={e => toNewPassword(e)} className="btn btn-lg mt-2" style={{ color: "white", backgroundColor: "#3CAEA3" }}>New password!</button>
            </div>
        </>
    )
}
